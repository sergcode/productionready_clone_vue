...
const mutations = {
  ...
  /** Это описание пустых мутаций, без них мутации не будут работать.
   * Без этих трех строчек ничего не будет работать, потому что мы не
   * можем использовать мутации которых не существует и мы обязаны где-то их зарегать.
   * Инициализацию этих функций обязательно нужно указать!!! */
